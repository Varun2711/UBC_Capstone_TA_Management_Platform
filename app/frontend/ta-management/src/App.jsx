...
import ManageApplications from "./pages/Scheduler/Scheduler_ManageApplications2";
import ViewStudentApplication from "./pages/Scheduler/Scheduler_ViewApplication2";
