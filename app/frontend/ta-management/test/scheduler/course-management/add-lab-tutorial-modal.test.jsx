...
const mockExistingSessions = {
  labs: [
    { id: 'lab1', section: 'Lab 01', day: 'Monday', time: '10:00 AM - 12:00 PM', location: 'CS Lab 101' },
  ],
  tutorials: [],
};
...
describe('AddLabTutorialModal', () => {
  ...
  describe('Rendering and Initialization', () => {
    it('should render the modal with correct initial data and empty fields', () => {
        ...
        expect(screen.getByRole('heading', { name: /add lab\/tutorial session/i })).toBeInTheDocument();
        expect(screen.getByText(/add a new lab or tutorial session for/i)).toBeInTheDocument();
        expect(screen.getByText(`${mockCourse.code} - ${mockOffering.section}`)).toBeInTheDocument();
        ...
        expect(screen.getByRole('combobox', { name: /session type/i })).toBeInTheDocument();
        ...
        expect(screen.getByRole('combobox', { name: /am\/pm/i })).toBeInTheDocument();
  ...
  describe('Validation and Interaction', () => {
    ...
    it('should suggest the next available section name', async () => {
      renderComponent({ existingSessions: { labs: [{ section: 'Lab 01' }], tutorials: [] }});
      ...
      expect(screen.getByRole('textbox', { name: /section name/i })).toHaveValue('Lab 02');
    });
